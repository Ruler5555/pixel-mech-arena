...
const AI_PRESETS = {
  balanced:   { id:'balanced',   name:'均衡', emoji:'⚖️', desc:'攻防节奏均衡, 全面稳定',
    ...
    closeL:0.50, closeH:0.32, closeBack:0.34, midApproach:0.55, midL:0.25, midDef:0.20,
  ...
  skirmisher: { id:'skirmisher', name:'游击', emoji:'🏹', desc:'打了就跑, 风筝走位',
    ...
    closeL:0.45, closeH:0.15, closeBack:0.40, midApproach:0.45, midL:0.45, midDef:0.15,
    jumpProb:0.22, airJumpProb:0.45, evadeProb:0.34 },
  ...
  precision:  { id:'precision',  name:'精准', emoji:'🎯', desc:'反应极快, 抓帧惩罚',
    reactMin:0.18, reactMax:0.38, defendProb:0.42, approachDist:130, closeDist:65,
    closeL:0.45, closeH:0.20, closeBack:0.20, midApproach:0.50, midL:0.30, midDef:0.20,
